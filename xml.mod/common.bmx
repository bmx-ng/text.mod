...
Extern
	...
	Function bmx_mxmlElementGetAttrByIndexNoName:String(handle:Byte Ptr, index:Int)
	Function bmx_mxmlElementGetAttrCaseInsensitive:String(handle:Byte Ptr, name:String, found:Int var)
	Function bmx_mxmlElementHasAttrCaseInsensitive:Int(handle:Byte Ptr, name:String)
	Function bmx_mxmlElementDeleteAttrCaseInsensitive(handle:Byte Ptr, name:String)
	...
	Function bmx_mxmlFindElementCaseInsensitive:Byte Ptr(handle:Byte Ptr, element:String, attr:String, value:String, descend:Int)
	...
	Function bmx_mxmlGetText:String(handle:Byte Ptr)
	...
	Function bmx_mxmlUnsetErrorCallback()
End Extern
